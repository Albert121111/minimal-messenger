-- Modern messenger features for an existing Minimal Messenger project.
-- Adds groups, avatars, replies, reactions, editing/deleting, read state,
-- pinned messages and private attachments.
begin;
